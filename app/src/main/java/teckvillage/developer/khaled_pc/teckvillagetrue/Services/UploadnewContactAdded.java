...
*/
            ...
            //Correct Solution
            datamodel datamodelBlocklist=new datamodel();
            //datamodelBlocklist.setContacts(listts);
            ...
            if (CheckNetworkConnection.hasInternetConnection(this)) {
                ...
                if (ConnectionDetector.hasInternetConnection(this)) {
                    ...
                    Call<ResultModelUploadVCF> uploadVCF = whoCallerApi.UploadNewContacts("application/json", ApiAccessToken.getAPIaccessToken(getApplicationContext()), datamodelBlocklist);
